...
/**
 *  This class setup the Annotation menu, creates and shows the annotation pop-up window
 *  
 * @author ePapyrus
 * 
...
public class AnnotSettingMenu {
	...
	/**
	 * enum to set and get the color types for the Annotation </br>
	 *  <b>Color  &nbsp;  Value  </b> 
	 *  </br>Black   &nbsp;    0
	 *  </br>Red     &nbsp;    1
	 *  </br>Yellow  &nbsp;    2
	...
	/**
	 * Constructor to assign the context and initialize the {@link LayoutInflater}.
	 * 
	...
	/**
	 * Returns the spinner position with respect to annotation color
	 * 
	 * @param color Color to get position of spinner
	 ...
	 * 
	 * @param pos  Spinner position to get the color
	...
	/**
	 * Given the annotation type and position of annotation pop-up it creates and shows the annotation tool's pop-up
	 * 
