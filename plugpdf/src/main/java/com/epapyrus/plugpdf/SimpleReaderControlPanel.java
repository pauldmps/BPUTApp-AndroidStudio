...
public class SimpleReaderControlPanel {
	...
	private void createPageDisplayPanel() {
		...
		displayBilateralButton.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				mParent.setBilateralVerticalMode();
				hide();
			}
		});
	...
	/**
	 * Shows anchor point specified the Panel corresponding to PanelType.
	 * 
	 ...
	 * @param index    depth level of the outline element in the outline tree
	 * @param title    outline title
	 * @param pageIdx  page number
	 * @param isChild  outline element is child 
	 */
