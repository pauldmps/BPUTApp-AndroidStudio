 ...
 * This is UI processing class with operations to be displayed to the user.
 * 
 * @author ePapyrus
 * 
...
public class SimpleReaderControlView extends RelativeLayout {
	...
	/**
	 * Initializes the UI components of PDF document viewer.
	 * 
	 ...
	 * @param pageCount  Total number of pages in PDF document
	 */
	 ...
	 * 
	 * @param on {@link Boolean} value to set search mode
	 */
	 ...
	 * 
	 * @param on {@link Boolean} value to set edit mode
	 */
	...
	/**
	 * Enables / disables the PDF document Outline button.
	 * 
	 * @param show {@link Boolean} value to enable or disable PDF document Outline button
	 */
	...
	/**
	 * Restores the state from the {@link Bundle} passed.
	 * 
	...
	/**
	 * Sets the preview display mode of each page.
	 */
	...
	/**
	 * It shows/hides the provided {@link Button} with respect to the given boolean value. 
	 * 
	 ...
	 * 
	 * @param types  {@link String} value to enables the annotation feature
	 * @param enable {@link Boolean} value to show/hide annotation button
	 */
