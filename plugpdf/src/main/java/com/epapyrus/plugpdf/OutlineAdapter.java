...
public class OutlineAdapter extends BaseAdapter {
	...
	*/
	...
	/**
	 * Set the value to enable/disable the add button from outline panel 
	 * 
	 * @param enable  {@link Boolean} value to enable/disable add button
	 */
	...
	/**
	 *  Set the value to enable/disable the remove button from outline panel
	 * 
	 * @param enable  {@link Boolean} value to enable/disable remove button
	 */
